...
| 012 | [Licensing and a clean-room boundary to the system being replaced](0012-licensing-clean-room.md) | decided | `routes/templates.rs` (entries written from upstream image docs) |
