...
### Preview environments <Badge text="shipped in 1.2" variant="success" />

A short-lived environment per pull request, with its own namespace, a time-to-live, and no secrets for forks. See [Preview environments](/docs/guides/previews/).
