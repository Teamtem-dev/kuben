...
Kuben does not delete audit records. The log lives in PostgreSQL; size it and back it up accordingly (see [Backup and restore](/docs/operations/backup-restore/)). Signed anchoring of the log is a planned extension.
</Aside>
