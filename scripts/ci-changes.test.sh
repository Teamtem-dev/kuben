...
check "mixed" "web go" apps/kuben/internal/httpapi/apps.go apps/console/src/lib/api.ts
check "new script" "scripts" scripts/check-drift.sh
check "trivy exceptions" "scripts" .trivyignore.yaml
check "dockerfile" "scripts" deploy/Dockerfile
check "go source" "go" apps/kuben/internal/core/perm/perm.go
check "go module" "go" apps/kuben/go.mod
check "go sums" "go" apps/kuben/go.sum go.work.sum
check "go tools" "go" tools/go.mod
check "go api types" "go" packages/api/v1alpha1/app.go
check "go agentlink protocol" "go" packages/api/agentlink/frame.go
check "go agent" "go" apps/kuben-agent/internal/link/link.go apps/kuben-agent/go.mod
check "go command" "go" apps/kuben/cmd/kuben/main.go
check "go workspace" "go" go.work
check "go oracle" "go" apps/kuben/test/oracle/oracle_test.go
...
check "go tool script" "scripts go" scripts/go-tool.sh
check "ts config package" "web" packages/typescript-config/base.json
