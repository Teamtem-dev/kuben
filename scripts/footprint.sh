#!/usr/bin/env bash
# Footprint measurement (ADR-031; first taken in M0). Run on the reference
# server after the platform is installed and has been idle for a few
# minutes:
#
#   sudo scripts/footprint.sh > footprint.md
#
